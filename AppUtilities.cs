// Required additional class libraries (in addition to standard libraries that appear in all pages by default)
using System.Web.UI;
...
public class AppUtilities
    {
        ...
        { // This class checks to see if a passed list is empty ot not empty
            ...
            // The Any method checks whether any of the element in a sequence satisfy a specific condition or not, i.e.
            // contains elements or does not contain elements. In this case, if the passed list in not (!) empty, then false will be returned
